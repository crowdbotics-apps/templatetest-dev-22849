...
## Project Structure
    ...
    ├── templatetest_dev_22849  # Django project configurations
...
1. Clone this repo and `cd templatetest_dev_22849`
...
2. Clone this repo and `cd templatetest_dev_22849`
